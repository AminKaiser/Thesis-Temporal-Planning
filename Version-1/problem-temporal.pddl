...
(maintenance-line sl10)

(=(train-speed drutojan)10)
...
(=(train-speed bonolota)10)
(train-at bonolota Dhaka)
(visited bonolota Dhaka)
(stoppage-at bonolota Dhaka-Biman-Bandar)
(stoppage-at bonolota Rajshahi)

(=(train-speed chitra)15)
(train-at chitra Khulna)
(visited chitra Khulna)
(stoppage-at chitra Tangail)
(stoppage-at chitra Bangabandhu-Setu)
(stoppage-at chitra Ishwardi)
(stoppage-at chitra Joydebpur)
(stoppage-at chitra Dhaka)
(stoppage-at chitra Dhaka-Biman-Bandar)
)
(:goal
(and(visited drutojan Tangail)
...
(visited chitra Tangail)
(visited chitra Bangabandhu-Setu)
(visited chitra Ishwardi)
(visited chitra Joydebpur)
(visited chitra Dhaka)
(visited chitra Dhaka-Biman-Bandar)
))
