(define (problem train-scheduling)
    ...
    (:objects 
        ;Train Name
        suborno truna bonolota ekota drutojan chitra sundorban paharika upobon - train
        ;Station Name
...
(=(train-speed ekota)10)
(train-at ekota Panchagar)
(visited ekota Panchagar)
(stoppage-at ekota Tangail)
(stoppage-at ekota Bangabandhu-Setu)
(stoppage-at ekota Ishwardi)
(stoppage-at ekota Joydebpur)
(stoppage-at ekota Dhaka)
(stoppage-at ekota Dhaka-Biman-Bandar)

(=(train-speed bonolota)15)
(train-at bonolota Dhaka)
(visited bonolota Dhaka)
(stoppage-at bonolota Dhaka-Biman-Bandar)
(stoppage-at bonolota Rajshahi)

(=(train-speed sundorban)15)
(train-at sundorban Dhaka)
(visited sundorban Dhaka)
(stoppage-at sundorban Tangail)
(stoppage-at sundorban Bangabandhu-Setu)
(stoppage-at sundorban Ishwardi)
(stoppage-at sundorban Joydebpur)
(stoppage-at sundorban Khulna)
(stoppage-at sundorban Dhaka-Biman-Bandar)

(=(train-speed drutojan)15)
(train-at drutojan Dhaka)
(visited drutojan Dhaka)
(stoppage-at drutojan Tangail)
(stoppage-at drutojan Bangabandhu-Setu)
(stoppage-at drutojan Ishwardi)
(stoppage-at drutojan Joydebpur)
(stoppage-at drutojan Panchagar)
(stoppage-at drutojan Dhaka-Biman-Bandar)

(=(train-speed upobon)10)
(train-at upobon Sylhet)
(visited upobon Sylhet)
(stoppage-at upobon Kulaura)
(stoppage-at upobon Shaestaganj)
(stoppage-at upobon Akhaura)
(stoppage-at upobon Brahmanbaria)
(stoppage-at upobon Bhairab)
(stoppage-at upobon Dhaka-Biman-Bandar)
(stoppage-at upobon Dhaka)
)
(:goal
(and(visited ekota Tangail)
(visited ekota Bangabandhu-Setu)
(visited ekota Ishwardi)
(visited ekota Joydebpur)
(visited ekota Dhaka)
(visited ekota Dhaka-Biman-Bandar)
(visited bonolota Dhaka-Biman-Bandar)
(visited bonolota Rajshahi)
(visited sundorban Tangail)
(visited sundorban Bangabandhu-Setu)
(visited sundorban Ishwardi)
(visited sundorban Joydebpur)
(visited sundorban Khulna)
(visited sundorban Dhaka-Biman-Bandar)
(visited drutojan Tangail)
(visited drutojan Bangabandhu-Setu)
(visited drutojan Ishwardi)
(visited drutojan Joydebpur)
(visited drutojan Panchagar)
(visited drutojan Dhaka-Biman-Bandar)
(visited upobon Kulaura)
(visited upobon Shaestaganj)
(visited upobon Akhaura)
(visited upobon Brahmanbaria)
(visited upobon Bhairab)
(visited upobon Dhaka-Biman-Bandar)
(visited upobon Dhaka)
))
