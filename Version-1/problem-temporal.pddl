...
(maintenance-line fl1)
(maintenance-line sl9)
(maintenance-line sl8)
(maintenance-line rl7)
(maintenance-line rl6)

(=(train-speed truna)15)
(train-at truna Chittagong)
(visited truna Chittagong)
(stoppage-at truna Akhaura)
(stoppage-at truna Brahmanbaria)
(stoppage-at truna Bhairab)
(stoppage-at truna Dhaka-Biman-Bandar)
(stoppage-at truna Dhaka)

(=(train-speed upobon)15)
...
(=(train-speed paharika)10)
(train-at paharika Chittagong)
(visited paharika Chittagong)
(stoppage-at paharika Akhaura)
(stoppage-at paharika Kulaura)
(stoppage-at paharika Sylhet)
)
(:goal
(and(visited truna Akhaura)
(visited truna Brahmanbaria)
(visited truna Bhairab)
(visited truna Dhaka-Biman-Bandar)
(visited truna Dhaka)
...
(visited paharika Akhaura)
(visited paharika Kulaura)
(visited paharika Sylhet)
))
